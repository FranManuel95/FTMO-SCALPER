...
def main():
    ...
    trades_file = out_dir / "usdjpy_candidate_trades.csv"
    trades.to_csv(trades_file, index=False)

    print(f"\nTrades guardados en: {trades_file}")

    if trades.empty:
        print("No hay trades para análisis mensual.")
        return
    ...
    monthly_file = out_dir / "usdjpy_candidate_monthly.csv"
