# backtest/run_xau_validation.py
...
def load_full_index():
    bt = XAUBacktester()
    df = bt._read_ohlc_csv(bt.DATA_PATH_M1)
    return df.index


def print_results_table(rows):
    print("\n" + "=" * 150)
    print("VALIDACIÓN TEMPORAL SELL_ONLY")
    print("=" * 150)
...
def main():
    ...
    rows.append(run_period("SECOND_HALF", start_date=split + pd.Timedelta(minutes=1), end_date=end))
